...
// atmega 2560 with LCD panel
#define OW_PIN  PF7 // arduino mega 2560 pin A7
#define OW_IN   PINF
#define OW_OUT  PORTF
#define OW_DDR  DDRF
...
#define OW_USE_INTERNAL_PULLUP     0  /* 0=ulkoinen, 1=sisäinen */

/*******************************************/

#define MAXSENSORS 8
#define MAXTEMPERATURES 5

#define OW_MATCH_ROM    0x55
#define OW_SKIP_ROM     0xCC
#define OW_SEARCH_ROM   0xF0

#define OW_SEARCH_FIRST 0xFF        // aloita uusi etsintä
#define OW_PRESENCE_ERR 0xFF
#define OW_DATA_ERR     0xFE
#define OW_LAST_DEVICE  0x00        // viimeinen löydetty laite
